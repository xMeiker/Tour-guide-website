...
<html lang="en">
   ...
   <body>
      ...
      <h1 class="heading-title"> Museos de Tijuana </h1>
      ...
      <section class="home-about">
         ...
         <div class="content">
            <h3>Museo de Cera de Tijuana</h3>
            <p>Centro cultural variado que presenta exhibiciones de arte, teatro, cine IMAX y eventos regulares.</p>
            <a target="_blank" href="https://maps.app.goo.gl/YAxCDoWRrwjdr7mW8" class="btn">ubicación</a><br>
      ...
      <section class="home-about">
         ...
         <div class="content">
            <h3>Museo del Coleccionista de Tijuana</h3>
            <p>Museo con una amplia variedad de juguetes y artículos de colección, además de recuerdos y figuras de la lucha.</p>
            <a target="_blank" href="https://maps.app.goo.gl/mYDXGe978hBMXHVq6" class="btn">ubicación</a><br>
            <a href="book.php" class="btn">reserva ahora</a>
         </div>
      ...
      <section class="home-about">
         ...
         <div class="content">
            <h3>1889 TJ Museum</h3>
            <p>Museo dedicado a la historia de la ciudad de Tijuana. Ubicado en la Zona Centro de nuestra ciudad.</p>
            <a target="_blank" href="https://maps.app.goo.gl/KjxfGawL76ARZibt6" class="btn">ubicación</a><br>
            <a href="book.php" class="btn">reserva ahora</a>
         </div>
      ...
      <section class="home-about">
         ...
         <div class="content">
            <h3>Museum of the Californias</h3>
            <p>Museo inaugurado el año 2000 con visitas guiadas y exhibiciones sobre la historia de Baja California.</p>
            <a target="_blank" href="https://maps.app.goo.gl/Cu1kfae782AUw1As5" class="btn">ubicación</a><br>
            <a href="book.php" class="btn">reserva ahora</a>
         </div>
      ...
      <section class="home-about">
         ...
         <div class="content">
            <h3>MULLME Museo de La Lucha Libre Mexicana</h3>
            <p>Si te gustan las luchas libres , este es un grandioso lugar para conocer y saber un poco mas sobre el tema.</p>
            <a target="_blank" href="https://maps.app.goo.gl/F73DdhaniCzuFdtP8" class="btn">ubicación</a><br>
            <a href="book.php" class="btn">reserva ahora</a>
         </div>
